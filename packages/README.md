...
- Light toggles (overhead, chandelier, keylight), both shades as one toggle, HVAC tile opens a full-screen HVAC view (target up/down, Off/Heat/Cool, auto-closes when idle); shades and HVAC buttons ignore touches shorter than 60 ms
